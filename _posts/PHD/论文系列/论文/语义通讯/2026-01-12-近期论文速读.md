 ...
 **TRANSCIEVER ARCHITECTURE OF GenSC** 

|           | Items                     | DeepSC                            | ECSC                                      | GenSC                                  |
|-----------|---------------------------|-----------------------------------|-------------------------------------------|----------------------------------------|
| Encoder   | Architecture              | Transformers                      | Transformer                               | Context Encoder                        |
|           | Embedding                 | Token Embedding + Positional Embedding | Word Embedding + Positional Embedding + Segment Embedding | Token Embedding + Positional Embedding |
| Decoder   | Main Task                 | Semantic Decoding                 | Semantic Decoding                         | Semantic Decoding/Generating           |
|           | Self-Attention Mechanism  | ✓                                 | ✓                                         | ✓                                      |
|           | Recursive Decoding Mechanism | None                            | Segment-Level Recursion                   | Token-Level Recursion                  |
